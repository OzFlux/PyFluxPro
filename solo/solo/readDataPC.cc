...
// ***********************
  {
	...
	in1 >> fileNameAccumError;
	in1 >> fileNameAccumRR;
	in1 >> fileNameTrainProcess;
	...
	in1 >> fileNameTrainWin;
	in1 >> fileNameTrainWout;
	in1.close();
	...
	std::cout << "PRINT OUT WHAT JUST READ:" << std::endl;
        ...
        std::cout << "fileNameAccumError: "<< fileNameAccumError << std::endl;
        std::cout << "fileNameAccumRR: "<< fileNameAccumRR << std::endl;
        std::cout << "fileNameTrainProcess: "<< fileNameTrainProcess << std::endl;
        ...
        std::cout << "fileNameTrainWin: " << fileNameTrainWin << std::endl;
        std::cout << "fileNameTrainWout: " << fileNameTrainWout << std::endl;
